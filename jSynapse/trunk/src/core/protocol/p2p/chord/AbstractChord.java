package core.protocol.p2p.chord;
...
public abstract class AbstractChord implements IChord {
	...
	// /////////////////////////////////////////// //
	/**
	 * @see core.protocol.p2p.chord.IChord#findSuccessor(int)
	 */
	...
	/**
	 * @see core.protocol.p2p.chord.IChord#closestPrecedingNode(int)
	 */
	...
	/**
	 * @see core.protocol.p2p.chord.IChord#join(Node)
	 */
...
//			predecessor = null;
	...
	/**
	 * @see core.protocol.p2p.chord.IChord#stabilize()
	 */
	...
	/**
	 * @see core.protocol.p2p.chord.IChord#notify()
	 */
