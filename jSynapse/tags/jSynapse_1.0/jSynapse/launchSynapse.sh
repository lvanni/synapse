...
sleep 2
gnome-terminal -e "java -cp bin example.chord.LaunchImpl localhost 8003 -j localhost 8001"


# Second Chord
sleep 2
gnome-terminal -e "java -cp bin example.chord.LaunchImpl localhost 8010 -s localhost 8003"       # Synapse
sleep 2
...
# third Chord
sleep 2
gnome-terminal -e "java -cp bin example.chord.LaunchImpl localhost 8020 -s localhost 8013"
sleep 2
...
sleep 2
gnome-terminal -e "java -cp bin example.chord.LaunchImpl localhost 8023 -j localhost 8021 -s localhost 8012"
