...
\title{Overnet : A Simple Protocol for Interconnecting Heterogeneous Overlay Networks}
...
%\boldmath
  ...
  is based on co-located nodes filling the role of \emph{neural
    synapses} between networks. We precisely capture the
  behavior of key metrics measuring Overnet, result of intensive
  simulations.

  Finally, we describe a new software prototype implementing Overnet
  in the precise case of the interconnection of many Chord
